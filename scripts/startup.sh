...
curl -H 'Cache-Control: no-cache' https://raw.githubusercontent.com/Amitie10g/docker-transmission/ocamlfuse/scripts/docker-helper.sh > $BIN_PATH/docker-helper.sh
